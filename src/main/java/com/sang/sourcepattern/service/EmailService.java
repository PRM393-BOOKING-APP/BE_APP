...
public interface EmailService {
    ...
    /**
     * Gửi email thông báo hủy lịch do quá hạn (không đề cập đến tiền bạc).
     * Áp dụng cho đơn đã duyệt (CONFIRMED).
     */
    void sendOverdueCancellationEmail(String toEmail, Booking booking);
}
